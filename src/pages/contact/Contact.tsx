      ...
      >
        ...
        '>
          <Flex className='items-center justify-center
           ...
           tabletM:flex-wrap
           '>
            <div className='h-40 w-40 bg-mercury-white-50 
            z-10 flex relative cursor-pointer
             items-center justify-center 
             flex-col p-4 text-center text-pastel-green-800 font-bold
             mobileL:w-72
             '>
              <div className='text-4xl absolute top-1 mobileL:text-5xl'><IoLocationOutline /></div>
            ...
            <div className='h-40 w-40 bg-mercury-white-50
             ...
             mobileL:w-72
             '>
              <div className='text-4xl absolute top-1  mobileL:text-5xl' ><FaFax /></div>
            ...
            <div className='h-40 w-40 bg-mercury-white-50
             ...
             mobileL:w-72
             '>
              <div className='text-4xl absolute top-1 mobileL:text-5xl'><RiMailSendLine /></div>
          ...
          <Flex className='items-center justify-center tabletM:mt-10'>
            <div className='w-96 bg-pastel-green-200 
            -mt-10 p-8
            tabletM:mt-10
            tabletM:p-10
            mobileL:w-72
            ...
            ' >
              ...
              justify-center flex-col'>
                ...
                <Button
                 className='bg-mercury-white-50 text-pastel-green-800 font-bold w-80
                 p-6 rounded-md
                hover:bg-pastel-green-800 hover:text-mercury-white-50
                mobileL:w-60
                 '
                >
                  Send Message
